function datapack_id:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    {text: "datapack_name"},\
    {translate: "datapack_id.description", fallback: "datapack_description"},\
    "",\
    ...
    [{"text": "modrinth.com/datapack/datapack_link", "color": "#a800a8"}],\
    "",\
    "",\
    "",\
    "",\
